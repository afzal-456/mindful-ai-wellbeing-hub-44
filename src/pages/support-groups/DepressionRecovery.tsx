      ...
      <main className="flex-grow py-16 px-6 md:px-10 lg:px-20">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="text-center mb-12">
            <h1 className="text-3xl md:text-4xl font-bold mb-4 text-wellness-dark">Depression Recovery Group</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">A safe space for sharing experiences and finding support on your recovery journey.</p>
          </div>
              ...
              <div className="w-full md:w-2/3">
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center text-gray-600 dark:text-gray-300">
                    ...
                    <span>Every Wednesday, 6:00 PM - 7:30 PM</span>
                  </div>
                  <div className="flex items-center text-gray-600 dark:text-gray-300">
                    <Users className="h-5 w-5 mr-2" />
                    <span>12 members (8 spots available)</span>
                  </div>
                </div>
                <Button 
                  ...
                  asChild
                >
                  <Link to="/support-groups/depression/community">Join Group Session</Link>
                </Button>
              </div>
...
export default DepressionRecovery;
